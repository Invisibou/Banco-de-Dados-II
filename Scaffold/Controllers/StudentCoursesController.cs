...
namespace Scaffold.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public StudentCoursesController(UnoescBd2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,CourseId,CancelData,SignDate")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,CourseId,CancelData,SignDate")] StudentCourse studentCourse)
        {
